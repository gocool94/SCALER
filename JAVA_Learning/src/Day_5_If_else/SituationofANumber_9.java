...
public class SituationofANumber_9 {
    /*
    Problem Description
Mr. ST is in troubles in with numbers,
he is confuse that number is positive-odd, positive-even, negative-odd OR negative-even.
